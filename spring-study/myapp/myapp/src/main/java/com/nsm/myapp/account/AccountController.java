...
// 컨트롤러에 RequestMapping을 사용하여 value 경로의 요청을 컨트롤러 내부의 메서드로 실행
// 서버 프로그램( 백엔드, backend )
// 요청에 대한 적절한 응답을 제공해주는 프로그램
// GET .../account -> Accountcontroller -> method(GET요청을

//JSON( JavaScript Object Notation)
//        :자바스크립트 객체 표기법(문자열)
//        :일반적으로 client(브라우저,앱)-server간 통신에
//        :데이터를 주고받을때 사용하는 데이터형식

public class AccountController {

    public void func() {
        Account acc = new Account("001","남소나",10000, new Date().getTime() );
